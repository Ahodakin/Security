                ...
                <div class="fond_blanc">
                    <div class="section_centrale">
                        ...
                        <div class="formulaire">
                                <div class="info">
                                  <h3>Les incendies en côte d'ivoire</h3>
                                    <p>Veuillez remplire ce formulaire </p>
                                </div> 

                           <form action="ajout6.php" method="POST">
                                <div class="champ">
                                    <fieldset> 
                                        <legend>Titre</legend>
                                    ...
                                    <fieldset> 
                                        <legend>types d'incendie</legend>
                                         <div>
                                            <select class="selectt" id="" name="typeIncendie"  required>
