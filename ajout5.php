...
//declaration de variables
    ...
    $insertion= $db->query("INSERT INTO suicides (titre,nbrevictimes,typesuicide,nbrenfants,nbrfemmes,nbrhommes,lieu,source,dateEvenement,datepost) 
    VALUES('$titre','$nbrevictimes','$typesuicide','$nbrenfants','$nbrfemmes','$nbrhommes','$lieu','$source','$dateEvenement','$datepost')");
